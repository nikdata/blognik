...
So how do we make this tidy-R (pun intended)? Here's the full code before we dive in to the details (with the results).
...
sample_cor <- as_tibble(sample_cor, rownames = 'variable') # save the row labels in their own column
